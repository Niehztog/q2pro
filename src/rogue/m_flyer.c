...
/*
static void showme1 (edict_t *self)
{
    if (!self->dmg)
    {
...
static void showme2 (edict_t *self)
{
    if (!self->dmg)
    {
        gi.dprintf ("strafe - %d\n", self->monsterinfo.lefty);
...
const mmove_t flyer_move_kamikaze = {FRAME_rollr02, FRAME_rollr06, flyer_frames_kamizake, flyer_kamikaze};
...
const mmove_t flyer_move_attack3 = {FRAME_attak201, FRAME_attak217, flyer_frames_attack3, flyer_run};
// pmm
