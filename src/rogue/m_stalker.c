...
const mmove_t stalker_move_idle = {FRAME_idle01, FRAME_idle21, stalker_frames_idle, stalker_stand};
...
const mmove_t stalker_move_idle2 = {FRAME_idle201, FRAME_idle213, stalker_frames_idle2, stalker_stand};
...
const mmove_t stalker_move_stand = {FRAME_idle01, FRAME_idle21, stalker_frames_stand, stalker_stand};
...
const mmove_t stalker_move_run = {FRAME_run01, FRAME_run04, stalker_frames_run, NULL};
...
const mmove_t stalker_move_walk = {FRAME_walk01, FRAME_walk08, stalker_frames_walk, stalker_walk};
...
const mmove_t stalker_move_false_death_end = { FRAME_reactive01, FRAME_reactive04, stalker_frames_reactivate, stalker_run };
...
const mmove_t stalker_move_false_death = {FRAME_twitch01, FRAME_twitch10, stalker_frames_false_death, stalker_false_death};
...
const mmove_t stalker_move_false_death_start = {FRAME_death01, FRAME_death09, stalker_frames_false_death_start, stalker_false_death};
...
const mmove_t stalker_move_pain = {FRAME_pain01, FRAME_pain04, stalker_frames_pain, stalker_run};
...
const mmove_t stalker_move_shoot = {FRAME_run01, FRAME_run04, stalker_frames_shoot, stalker_run};
...
const mmove_t stalker_move_swing_l = {FRAME_attack01, FRAME_attack08, stalker_frames_swing_l, stalker_run};
...
const mmove_t stalker_move_swing_r = {FRAME_attack11, FRAME_attack15, stalker_frames_swing_r, stalker_run};
...
// RAD2DEG/DEG2RAD come from the engine's shared.h
#define FAUX_GRAVITY    800.0f

// ====================
// ====================
static void calcJumpAngle(vec3_t start, vec3_t end, float velocity, vec3_t angles)
{
    float   distV, distH;
    float   one, cosU;
    float   l, U;
...
// ====================
// ====================
static int stalker_check_lz(edict_t *self, edict_t *target, vec3_t dest)
{
    vec3_t  jumpLZ;
...
const mmove_t stalker_move_jump_straightup = {FRAME_jump04, FRAME_jump07, stalker_frames_jump_straightup, stalker_run};
...
const mmove_t stalker_move_dodge_run = {FRAME_run01, FRAME_run04, stalker_frames_dodge_run, NULL};
...
static void stalker_jump_wait_land(edict_t *self)
{
    if ((random() < (0.3f + (0.1f * (float)(skill->value)))) && (level.time >= self->monsterinfo.attack_finished)) {
...
const mmove_t stalker_move_jump_up = { FRAME_jump01, FRAME_jump07, stalker_frames_jump_up, stalker_run };
...
const mmove_t stalker_move_jump_down = { FRAME_jump01, FRAME_jump07, stalker_frames_jump_down, stalker_run };
...
const mmove_t stalker_move_death = {FRAME_death01, FRAME_death09, stalker_frames_death, stalker_dead};
