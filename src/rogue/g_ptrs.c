...
#include "g_local.h"
#include "g_ptrs.h"
extern bool berserk_blocked(edict_t *, float);
extern bool Boss2_CheckAttack(edict_t *);
extern bool Carrier_CheckAttack(edict_t *);
extern bool chick_blocked(edict_t *, float);
extern bool floater_blocked(edict_t *, float);
extern bool flyer_blocked(edict_t *, float);
extern bool gladiator_blocked(edict_t *, float);
extern bool gunner_blocked(edict_t *, float);
extern bool hover_blocked(edict_t *, float);
extern bool infantry_blocked(edict_t *, float);
extern bool Jorg_CheckAttack(edict_t *);
extern bool M_CheckAttack(edict_t *);
extern bool Makron_CheckAttack(edict_t *);
extern bool medic_blocked(edict_t *, float);
extern bool medic_checkattack(edict_t *);
extern bool mutant_blocked(edict_t *, float);
extern bool mutant_checkattack(edict_t *);
extern bool parasite_blocked(edict_t *, float);
extern bool parasite_checkattack(edict_t *);
extern bool soldier_blocked(edict_t *, float);
extern bool stalker_blocked(edict_t *, float);
extern bool supertank_blocked(edict_t *, float);
extern bool tank_blocked(edict_t *, float);
extern bool turret_checkattack(edict_t *);
extern bool Widow2_CheckAttack(edict_t *);
extern bool widow_blocked(edict_t *, float);
extern bool Widow_CheckAttack(edict_t *);
...
extern const mmove_t carrier_move_attack_gren;
extern const mmove_t carrier_move_attack_mg;
extern const mmove_t carrier_move_attack_post_gren;
extern const mmove_t carrier_move_attack_post_mg;
extern const mmove_t carrier_move_attack_pre_gren;
extern const mmove_t carrier_move_attack_pre_mg;
extern const mmove_t carrier_move_attack_rail;
extern const mmove_t carrier_move_attack_rocket;
extern const mmove_t carrier_move_death;
extern const mmove_t carrier_move_pain_heavy;
extern const mmove_t carrier_move_pain_light;
extern const mmove_t carrier_move_run;
extern const mmove_t carrier_move_spawn;
extern const mmove_t carrier_move_stand;
extern const mmove_t carrier_move_walk;
...
extern const mmove_t floater_move_attack1a;
...
extern const mmove_t hover_move_attack2;
...
extern const mmove_t medic_move_callReinforcements;
...
extern const mmove_t soldier_move_blind;
...
extern const mmove_t stalker_move_death;
extern const mmove_t stalker_move_false_death;
extern const mmove_t stalker_move_false_death_end;
extern const mmove_t stalker_move_false_death_start;
extern const mmove_t stalker_move_idle2;
extern const mmove_t stalker_move_idle;
...
extern const mmove_t stalker_move_pain;
extern const mmove_t stalker_move_run;
extern const mmove_t stalker_move_shoot;
extern const mmove_t stalker_move_stand;
extern const mmove_t stalker_move_swing_l;
extern const mmove_t stalker_move_swing_r;
extern const mmove_t stalker_move_walk;
...
extern const mmove_t turret_move_ready_gun;
extern const mmove_t turret_move_run;
extern const mmove_t turret_move_seek;
extern const mmove_t turret_move_stand;
extern const mmove_t widow2_move_attack_beam;
extern const mmove_t widow2_move_attack_disrupt;
extern const mmove_t widow2_move_attack_post_beam;
extern const mmove_t widow2_move_attack_pre_beam;
extern const mmove_t widow2_move_dead;
extern const mmove_t widow2_move_death;
extern const mmove_t widow2_move_pain;
extern const mmove_t widow2_move_really_dead;
extern const mmove_t widow2_move_run;
extern const mmove_t widow2_move_spawn;
extern const mmove_t widow2_move_stand;
extern const mmove_t widow2_move_tongs;
extern const mmove_t widow2_move_walk;
extern const mmove_t widow_move_attack_blaster;
extern const mmove_t widow_move_attack_kick;
...
extern const mmove_t widow_move_attack_pre_blaster;
extern const mmove_t widow_move_attack_pre_rail;
...
extern const mmove_t widow_move_death;
extern const mmove_t widow_move_pain_heavy;
extern const mmove_t widow_move_pain_light;
extern const mmove_t widow_move_run;
...
extern void badarea_touch(edict_t *, edict_t *, cplane_t *, csurface_t *);
...
extern void berserk_sidestep(edict_t *);
...
extern void blaster2_touch(edict_t *, edict_t *, cplane_t *, csurface_t *);
...
extern void carrier_die(edict_t *, edict_t *, edict_t *, int, vec3_t);
...
extern void DBall_BallTouch(edict_t *, edict_t *, cplane_t *, csurface_t *);
extern void DBall_GoalTouch(edict_t *, edict_t *, cplane_t *, csurface_t *);
extern void DBall_SpeedTouch(edict_t *, edict_t *, cplane_t *, csurface_t *);
...
extern void doppleganger_die(edict_t *, edict_t *, edict_t *, int, vec3_t);
...
extern void fd_secret_done(edict_t *);
extern void fd_secret_killed(edict_t *, edict_t *, edict_t *, int, vec3_t);
extern void fd_secret_move1(edict_t *);
extern void fd_secret_move2(edict_t *);
extern void fd_secret_move3(edict_t *);
extern void fd_secret_move4(edict_t *);
extern void fd_secret_move5(edict_t *);
extern void fd_secret_move6(edict_t *);
extern void fd_secret_use(edict_t *, edict_t *, edict_t *);
extern void flechette_touch(edict_t *, edict_t *, cplane_t *, csurface_t *);
...
extern void hunter_touch(edict_t *, edict_t *, cplane_t *, csurface_t *);
...
extern void medic_duck(edict_t *, float);
...
extern void medic_sidestep(edict_t *);
...
extern void monster_duck_up(edict_t *);
...
extern void nuke_bounce(edict_t *, edict_t *, cplane_t *, csurface_t *);
extern void nuke_die(edict_t *, edict_t *, edict_t *, int, vec3_t);
...
extern void plat2_hit_bottom(edict_t *);
extern void plat2_hit_top(edict_t *);
...
extern void prox_die(edict_t *, edict_t *, edict_t *, int, vec3_t);
extern void Prox_Explode(edict_t *);
extern void Prox_Field_Touch(edict_t *, edict_t *, cplane_t *, csurface_t *);
extern void prox_land(edict_t *, edict_t *, cplane_t *, csurface_t *);
...
extern void secret_touch(edict_t *, edict_t *, cplane_t *, csurface_t *);
...
extern void tesla_lava(edict_t *, edict_t *, cplane_t *, csurface_t *);
extern void tesla_think(edict_t *);
extern void tesla_think_active(edict_t *);
extern void tesla_zap(edict_t *, edict_t *, cplane_t *, csurface_t *);
...
extern void Touch_Plat_Center2(edict_t *, edict_t *, cplane_t *, csurface_t *);
extern void tracker_fly(edict_t *);
extern void tracker_pain_daemon_think(edict_t *);
extern void tracker_touch(edict_t *, edict_t *, cplane_t *, csurface_t *);
extern void train_blocked(edict_t *, edict_t *);
extern void train_next(edict_t *);
extern void train_piece_wait(edict_t *);
...
extern void trigger_teleport_touch(edict_t *, edict_t *, cplane_t *, csurface_t *);
...
extern void turret_die(edict_t *, edict_t *, edict_t *, int, vec3_t);
...
extern void turret_pain(edict_t *, edict_t *, float, int);
extern void turret_run(edict_t *);
extern void turret_search(edict_t *);
extern void turret_sight(edict_t *, edict_t *);
extern void turret_stand(edict_t *);
extern void turret_wake(edict_t *);
...
extern void vengeance_touch(edict_t *, edict_t *, cplane_t *, csurface_t *);
extern void walkmonster_start_go(edict_t *);
extern void widow2_attack(edict_t *);
extern void widow2_die(edict_t *, edict_t *, edict_t *, int, vec3_t);
...
extern void widow_die(edict_t *, edict_t *, edict_t *, int, vec3_t);
extern void widow_gib_touch(edict_t *, edict_t *, cplane_t *, csurface_t *);
extern void widow_melee(edict_t *);
extern void widow_pain(edict_t *, edict_t *, float, int);
extern void widow_run(edict_t *);
extern void widow_search(edict_t *);
...
{ P_touch, Prox_Field_Touch },
{ P_touch, prox_land },
{ P_touch, rocket_touch },
{ P_touch, rotating_touch },
{ P_touch, secret_touch },
...
{ P_pain, carrier_pain },
{ P_pain, chick_pain },
{ P_pain, DBall_BallPain },
{ P_pain, defender_pain },
{ P_pain, doppleganger_pain },
{ P_pain, flipper_pain },
{ P_pain, floater_pain },
{ P_pain, flyer_pain },
...
{ P_die, doppleganger_die },
{ P_die, fd_secret_killed },
{ P_die, flipper_die },
{ P_die, floater_die },
{ P_die, flyer_die },
...
{ P_die, prox_die },
{ P_die, soldier_die },
{ P_die, sphere_explode },
{ P_die, sphere_if_idle_die },
{ P_die, stalker_die },
{ P_die, supertank_die },
{ P_die, tank_die },
{ P_die, tesla_die },
...
{ P_moveinfo_endfunc, fd_secret_done },
{ P_moveinfo_endfunc, fd_secret_move1 },
{ P_moveinfo_endfunc, fd_secret_move3 },
{ P_moveinfo_endfunc, fd_secret_move5 },
...
{ P_monsterinfo_currentmove, &widow2_move_attack_beam },
{ P_monsterinfo_currentmove, &widow2_move_attack_disrupt },
{ P_monsterinfo_currentmove, &widow2_move_attack_post_beam },
{ P_monsterinfo_currentmove, &widow2_move_attack_pre_beam },
{ P_monsterinfo_currentmove, &widow2_move_dead },
{ P_monsterinfo_currentmove, &widow2_move_death },
{ P_monsterinfo_currentmove, &widow2_move_pain },
{ P_monsterinfo_currentmove, &widow2_move_really_dead },
{ P_monsterinfo_currentmove, &widow2_move_run },
{ P_monsterinfo_currentmove, &widow2_move_spawn },
{ P_monsterinfo_currentmove, &widow2_move_stand },
{ P_monsterinfo_currentmove, &widow2_move_tongs },
{ P_monsterinfo_currentmove, &widow2_move_walk },
{ P_monsterinfo_currentmove, &widow_move_attack_blaster },
{ P_monsterinfo_currentmove, &widow_move_attack_kick },
{ P_monsterinfo_currentmove, &widow_move_attack_post_blaster },
{ P_monsterinfo_currentmove, &widow_move_attack_post_blaster_l },
{ P_monsterinfo_currentmove, &widow_move_attack_post_blaster_r },
{ P_monsterinfo_currentmove, &widow_move_attack_pre_blaster },
{ P_monsterinfo_currentmove, &widow_move_attack_pre_rail },
{ P_monsterinfo_currentmove, &widow_move_attack_rail },
{ P_monsterinfo_currentmove, &widow_move_attack_rail_l },
{ P_monsterinfo_currentmove, &widow_move_attack_rail_r },
{ P_monsterinfo_currentmove, &widow_move_death },
{ P_monsterinfo_currentmove, &widow_move_pain_heavy },
{ P_monsterinfo_currentmove, &widow_move_pain_light },
{ P_monsterinfo_currentmove, &widow_move_run },
{ P_monsterinfo_currentmove, &widow_move_run_attack },
...
{ P_monsterinfo_stand, widow2_stand },
{ P_monsterinfo_stand, widow_stand },
...
{ P_monsterinfo_search, widow2_search },
{ P_monsterinfo_search, widow_search },
...
{ P_monsterinfo_walk, widow2_walk },
{ P_monsterinfo_walk, widow_walk },
...
{ P_monsterinfo_run, widow2_run },
{ P_monsterinfo_run, widow_run },
...
{ P_monsterinfo_attack, widow2_attack },
{ P_monsterinfo_attack, widow_attack },
...
{ P_monsterinfo_melee, widow2_melee },
{ P_monsterinfo_melee, widow_melee },
...
{ P_monsterinfo_sight, widow_sight },
...
{ P_monsterinfo_checkattack, parasite_checkattack },
