...
static void gladb_cleaver_swing(edict_t *self)
{
    gi.sound(self, CHAN_WEAPON, sound_cleaver_swing, 1, ATTN_NORM, 0);
}

static const mframe_t gladb_frames_stand[] = {
    { ai_stand, 0, NULL },
    { ai_stand, 0, NULL },
    { ai_stand, 0, NULL },
    { ai_stand, 0, NULL },
...
const mmove_t gladb_move_stand = {FRAME_stand1, FRAME_stand7, gladb_frames_stand, NULL};
...
static const mframe_t gladb_frames_walk[] = {
    { ai_walk, 15, NULL },
    { ai_walk, 7,  NULL },
    { ai_walk, 6,  NULL },
    { ai_walk, 5,  NULL },
...
const mmove_t gladb_move_walk = {FRAME_walk1, FRAME_walk16, gladb_frames_walk, NULL};
...
static const mframe_t gladb_frames_run[] = {
    { ai_run, 23, NULL },
    { ai_run, 14, NULL },
    { ai_run, 14, NULL },
    { ai_run, 21, NULL },
...
const mmove_t gladb_move_run = {FRAME_run1, FRAME_run6, gladb_frames_run, NULL};
...
static void GladbMelee(edict_t *self)
{
    vec3_t  aim;
...
static const mframe_t gladb_frames_attack_melee[] = {
    { ai_charge, 0, NULL },
    { ai_charge, 0, NULL },
    { ai_charge, 0, NULL },
    { ai_charge, 0, NULL },
...
const mmove_t gladb_move_attack_melee = {FRAME_melee1, FRAME_melee17, gladb_frames_attack_melee, gladb_run};
...
const mmove_t gladb_move_attack_gun = {FRAME_attack1, FRAME_attack9, gladb_frames_attack_gun, gladb_run};
...
static const mframe_t gladb_frames_pain[] = {
    { ai_move, 0, NULL },
    { ai_move, 0, NULL },
    { ai_move, 0, NULL },
    { ai_move, 0, NULL },
...
const mmove_t gladb_move_pain = {FRAME_pain1, FRAME_pain6, gladb_frames_pain, gladb_run};

static const mframe_t gladb_frames_pain_air[] = {
    { ai_move, 0, NULL },
    { ai_move, 0, NULL },
    { ai_move, 0, NULL },
    { ai_move, 0, NULL },
...
const mmove_t gladb_move_pain_air = {FRAME_painup1, FRAME_painup7, gladb_frames_pain_air, gladb_run};
...
static void gladb_dead(edict_t *self)
{
...
static const mframe_t gladb_frames_death[] = {
    { ai_move, 0, NULL },
    { ai_move, 0, NULL },
    { ai_move, 0, NULL },
    { ai_move, 0, NULL },
...
const mmove_t gladb_move_death = {FRAME_death1, FRAME_death22, gladb_frames_death, gladb_dead};
...
static void gladb_precache(void)
{
