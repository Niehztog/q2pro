...
static void SetupRotationMatrix(vec3_t matrix[3], const vec3_t dir, float degrees)
{
...
static void RotatePointAroundVector(vec3_t out, const vec3_t dir, const vec3_t in, float degrees)
{
    vec3_t matrix[3];
    vec3_t temp;
