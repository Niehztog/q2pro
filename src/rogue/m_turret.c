...
const mmove_t turret_move_stand = {FRAME_stand01, FRAME_stand02, turret_frames_stand, NULL};
...
const mmove_t turret_move_ready_gun = { FRAME_active01, FRAME_run01, turret_frames_ready_gun, turret_run };
...
const mmove_t turret_move_seek = {FRAME_run01, FRAME_run02, turret_frames_seek, NULL};
...
const mmove_t turret_move_run = {FRAME_run01, FRAME_run02, turret_frames_run, turret_run};
...
//      gi.dprintf("off-angle\n");
    ...
    chance = chance - (0.2f * skill->value);
...
const mmove_t turret_move_fire = {FRAME_pow01, FRAME_pow04, turret_frames_fire, turret_run};
...
const mmove_t turret_move_fire_blind = {FRAME_pow01, FRAME_pow04, turret_frames_fire_blind, turret_run};
//pmm
